...
Github-Pages on: https://eltonaugusto.github.io/c4-draw.io/
...
https://github.com/eltonaugusto/c4-draw.io[draw.io], which provides
...
5.  Put in the field kbd:[Enter Value (URL):] the link to the plugin: kbd:[https://eltonaugusto.github.io/c4-draw.io/c4.js]
...
Sorry for these issues, I keep fixing these in my spare time, feel free to create an link:https://github.com/eltonaugusto/c4-draw.io/issues[issue], or provide an pull request, hints and ideas what We could improve!
